...
function ShelfShell({ children }: { children: React.ReactNode }) {
  ...
  const label = pathname.startsWith("/movies") ? "Movies" : pathname.startsWith("/tv") ? "TV" : pathname.startsWith("/books") ? "Books" : pathname.startsWith("/admin/new") ? "Add item" : pathname.startsWith("/admin/login") ? "Log in" : pathname.startsWith("/admin") ? "Admin" : pathname.startsWith("/item") ? "Item" : "Home"
