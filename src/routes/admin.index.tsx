    ...
    <main className="container mx-auto max-w-4xl px-4 py-10">
      <div className="mb-8 flex items-end justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button render={<Link to="/admin/import" />} variant="outline">
            <UploadIcon /> Import
          </Button>
          <Button onClick={signOut} size="icon" title="Log out" variant="ghost">
            <LogOut />
          </Button>
        </div>
      </div>
        ...
        {items.map((item) => (
          ...
          >
            ...
            <div className="flex gap-1">
              <Button
                render={
                  <Link params={{ id: String(item.id) }} to="/admin/$id" />
                }
                size="icon"
